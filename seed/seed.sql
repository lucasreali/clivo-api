...
INSERT INTO tenant (id, name, legal_name, tax_id, segment, status, status_reason, status_changed_at, created_at) VALUES
 ('0a000000-0000-7000-8000-000000000001', 'Vida Clinic', 'Vida Integrated Health Clinic LLC', '11222333000181', 'Integrative health', 'ACTIVE', NULL, now() - interval '400 days', now() - interval '400 days'),
 ('0a000000-0000-7000-8000-000000000002', 'Odonto Sorriso', 'Odonto Sorriso Dental Services LLC', '22333444000181', 'Dentistry', 'ACTIVE', NULL, now() - interval '200 days', now() - interval '200 days'),
 ('0a000000-0000-7000-8000-000000000003', 'Pet Care', 'Pet Care Veterinary Clinic LLC', '33444555000181', 'Veterinary', 'SUSPENDED', 'Platform subscription overdue', now() - interval '15 days', now() - interval '120 days');
...
INSERT INTO app_user (id, tenant_id, name, email, password_hash, user_role, status, last_login_at, created_at) VALUES
 ('0b000000-0000-7000-8000-000000000001', NULL,                                   'Platform Administrator', 'admin@mail.com',  '$2a$10$rPtfHczEJnYClCFrJRqpYuQEJ1PwwNLR3rwZ/j7.6MLPXke6wUjkq', 'PLATFORM_ADMIN', 'ACTIVE',   now() - interval '1 day',   now() - interval '400 days'),
...
INSERT INTO tenant_module (tenant_id, module_code, enabled, enabled_at, enabled_by) VALUES
 -- Vida Clinic: everything except the odontogram, which was tried and turned off
...
INSERT INTO specialty (id, tenant_id, name) VALUES
 ('0c000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', 'Physiotherapy'),
 ('0c000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', 'Nutrition'),
 ('0c000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', 'Dermatology'),
 ('0c000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000002', 'General Dentistry'),
 ('0c000000-0000-7000-8000-000000000005', '0a000000-0000-7000-8000-000000000002', 'Orthodontics'),
 ('0c000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000003', 'Veterinary Medicine');
...
INSERT INTO service (id, tenant_id, name, duration_min, price, specialty_id, status) VALUES
 ('0f000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', 'Physiotherapy Session',    60, 180.00, '0c000000-0000-7000-8000-000000000001', 'ACTIVE'),
 ('0f000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', 'Nutrition Consultation',   45, 150.00, '0c000000-0000-7000-8000-000000000002', 'ACTIVE'),
 ('0f000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', 'Dermatology Assessment',   30, 220.00, '0c000000-0000-7000-8000-000000000003', 'ACTIVE'),
 ('0f000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000001', 'Therapeutic Massage',      50, 130.00, NULL,                                   'INACTIVE'),
 ('0f000000-0000-7000-8000-000000000005', '0a000000-0000-7000-8000-000000000002', 'Dental Cleaning',          40, 120.00, '0c000000-0000-7000-8000-000000000004', 'ACTIVE'),
 ('0f000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000002', 'Braces Adjustment',        30,  90.00, '0c000000-0000-7000-8000-000000000005', 'ACTIVE'),
 ('0f000000-0000-7000-8000-000000000007', '0a000000-0000-7000-8000-000000000003', 'Veterinary Consultation',  30, 140.00, '0c000000-0000-7000-8000-000000000006', 'ACTIVE');
...
INSERT INTO customer (id, tenant_id, name, national_id, birth_date, phone, email, postal_code, street, status, deactivation_reason, created_at, updated_at, updated_by) VALUES
 ...
 ('10000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000001', 'Diego Santos',      '52998224725', DATE '1978-01-30', '41999990004', 'diego.santos@mail.com',      NULL,       NULL,                         'INACTIVE', 'Moved to another city and asked to close the record', now() - interval '250 days', now() - interval '5 days',   '0b000000-0000-7000-8000-000000000002'),
...
INSERT INTO dependent (id, tenant_id, customer_id, name, dependent_type, birth_date, attributes, status, created_at) VALUES
 ('11000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000001', 'Miguel Prado',     'MINOR',    DATE '2018-04-10', '{"relationship": "child"}',                                        'ACTIVE', now() - interval '370 days'),
 ('11000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000002', 'Alzira Carvalho',  'ASSISTED', DATE '1940-12-01', '{"condition": "reduced mobility"}',                            'ACTIVE', now() - interval '290 days'),
 ('11000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000003', '10000000-0000-7000-8000-000000000007', 'Thor',             'ANIMAL',   DATE '2020-08-15', '{"species": "Dog", "breed": "Golden Retriever", "weightKg": 32.5}',  'ACTIVE', now() - interval '110 days'),
 ('11000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000003', '10000000-0000-7000-8000-000000000007', 'Mel',              'ANIMAL',   DATE '2022-01-20', '{"species": "Cat", "breed": "Mixed breed", "weightKg": 4.2}',               'ACTIVE', now() - interval '100 days');

INSERT INTO consent (id, tenant_id, customer_id, purpose, granted, source, recorded_at) VALUES
 ('12000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000001', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '380 days'),
 ...
 ('12000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000002', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '300 days'),
 ('12000000-0000-7000-8000-000000000005', '0a000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000003', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '150 days'),
 ('12000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000001', '10000000-0000-7000-8000-000000000004', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '250 days'),
 ('12000000-0000-7000-8000-000000000007', '0a000000-0000-7000-8000-000000000002', '10000000-0000-7000-8000-000000000005', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '190 days'),
 ('12000000-0000-7000-8000-000000000008', '0a000000-0000-7000-8000-000000000002', '10000000-0000-7000-8000-000000000006', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '120 days'),
 ('12000000-0000-7000-8000-000000000009', '0a000000-0000-7000-8000-000000000003', '10000000-0000-7000-8000-000000000007', 'DATA_PROCESSING', true,  'REGISTRATION_FORM', now() - interval '110 days');

-- ---------------------------------------------------------------------------
-- Insurance (module `insurance`, Vida Clinic only)
-- ---------------------------------------------------------------------------
...
INSERT INTO insurance_plan (id, tenant_id, name, reimbursement_pct, status) VALUES
 ...
 ('13000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', 'Bradesco Saude',  50.00, 'ACTIVE'),
 ('13000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', 'Legacy Plan',      0.00, 'INACTIVE');
...
INSERT INTO record_template (id, tenant_id, name, version, status, cloned_from, requires_module, created_at) VALUES
 ('15000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', 'Physiotherapy Record', 1, 'PUBLISHED', NULL,                                   NULL,         now() - interval '330 days'),
 ('15000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', 'Nutrition Record',     1, 'PUBLISHED', NULL,                                   NULL,         now() - interval '320 days'),
 ('15000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', 'Physiotherapy Record', 2, 'DRAFT',     '15000000-0000-7000-8000-000000000001', NULL,         now() - interval '10 days'),
 ('15000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000002', 'Dental Record',        1, 'PUBLISHED', NULL,                                   'odontogram', now() - interval '199 days'),
 ('15000000-0000-7000-8000-000000000005', '0a000000-0000-7000-8000-000000000003', 'Veterinary Record',    1, 'PUBLISHED', NULL,                                   NULL,         now() - interval '119 days'),
 ('15000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000001', 'Default Record',       1, 'PUBLISHED', NULL,                                   NULL,         now() - interval '395 days');

INSERT INTO template_section (id, record_template_id, name, sort_order) VALUES
 ('16000000-0000-7000-8000-000000000001', '15000000-0000-7000-8000-000000000001', 'Assessment',     1),
 ('16000000-0000-7000-8000-000000000002', '15000000-0000-7000-8000-000000000001', 'Progress',       2),
 ('16000000-0000-7000-8000-000000000003', '15000000-0000-7000-8000-000000000002', 'Anthropometry',  1),
 ('16000000-0000-7000-8000-000000000004', '15000000-0000-7000-8000-000000000002', 'Meal Plan',      2),
 ('16000000-0000-7000-8000-000000000005', '15000000-0000-7000-8000-000000000003', 'Assessment',     1),
 ('16000000-0000-7000-8000-000000000006', '15000000-0000-7000-8000-000000000004', 'Examination',    1),
 ('16000000-0000-7000-8000-000000000007', '15000000-0000-7000-8000-000000000004', 'Procedure',      2),
 ('16000000-0000-7000-8000-000000000008', '15000000-0000-7000-8000-000000000005', 'Anamnesis',      1),
 ('16000000-0000-7000-8000-000000000009', '15000000-0000-7000-8000-000000000006', 'Anamnesis',      1),
 ('16000000-0000-7000-8000-00000000000a', '15000000-0000-7000-8000-000000000006', 'Plan',           2);
...
INSERT INTO template_field (id, template_section_id, code, label, field_type, component, required, sort_order, options, validation, requires_module) VALUES
 ('17000000-0000-7000-8000-000000000001', '16000000-0000-7000-8000-000000000001', 'pain_scale',        'Pain (0 to 10)',        'SCALE',         NULL,           true,  1, NULL,                                                        '{"min": 0, "max": 10}',    NULL),
 ('17000000-0000-7000-8000-000000000002', '16000000-0000-7000-8000-000000000001', 'region',            'Treated region',        'SINGLE_CHOICE', NULL,           false, 2, '["Cervical", "Lumbar", "Knee", "Shoulder"]',                  NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000003', '16000000-0000-7000-8000-000000000001', 'body_map',          'Body map',              'COMPONENT',     'BODY_MAP',     false, 3, '["cervical", "lumbar", "knee", "shoulder"]',                  NULL,                       'bodymap'),
 ('17000000-0000-7000-8000-000000000004', '16000000-0000-7000-8000-000000000002', 'progress',          'Session progress',      'LONG_TEXT',     NULL,           false, 1, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000005', '16000000-0000-7000-8000-000000000002', 'expected_discharge','Expected discharge',    'DATE',          NULL,           false, 2, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000006', '16000000-0000-7000-8000-000000000003', 'weight_kg',         'Weight (kg)',           'DECIMAL',       NULL,           true,  1, NULL,                                                        '{"min": 1, "max": 400}',   NULL),
 ('17000000-0000-7000-8000-000000000007', '16000000-0000-7000-8000-000000000003', 'height_cm',         'Height (cm)',           'INTEGER',       NULL,           true,  2, NULL,                                                        '{"min": 30, "max": 250}',  NULL),
 ('17000000-0000-7000-8000-000000000008', '16000000-0000-7000-8000-000000000004', 'goal',              'Goal',                  'SINGLE_CHOICE', NULL,           false, 1, '["Weight loss", "Muscle gain", "Maintenance"]',             NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000009', '16000000-0000-7000-8000-000000000004', 'guidance',          'Guidance',              'LONG_TEXT',     NULL,           false, 2, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-00000000000a', '16000000-0000-7000-8000-000000000005', 'pain_scale',        'Pain (0 to 10)',        'SCALE',         NULL,           true,  1, NULL,                                                        '{"min": 0, "max": 10}',    NULL),
 ('17000000-0000-7000-8000-00000000000b', '16000000-0000-7000-8000-000000000005', 'region',            'Treated region',        'SINGLE_CHOICE', NULL,           false, 2, '["Cervical", "Lumbar", "Knee", "Shoulder"]',                  NULL,                       NULL),
 ('17000000-0000-7000-8000-00000000000c', '16000000-0000-7000-8000-000000000005', 'planned_sessions',  'Planned sessions',      'INTEGER',       NULL,           false, 3, NULL,                                                        '{"min": 1, "max": 60}',    NULL),
 ('17000000-0000-7000-8000-00000000000d', '16000000-0000-7000-8000-000000000006', 'odontogram',        'Odontogram',            'COMPONENT',     'ODONTOGRAM',   false, 1, NULL,                                                        NULL,                       'odontogram'),
 ('17000000-0000-7000-8000-00000000000e', '16000000-0000-7000-8000-000000000006', 'exam_notes',        'Examination notes',     'LONG_TEXT',     NULL,           false, 2, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-00000000000f', '16000000-0000-7000-8000-000000000007', 'procedure',         'Procedure performed',   'SHORT_TEXT',    NULL,           true,  1, NULL,                                                        '{"maxLength": 120}',       NULL),
 ('17000000-0000-7000-8000-000000000010', '16000000-0000-7000-8000-000000000008', 'species',           'Species',               'SHORT_TEXT',    NULL,           true,  1, NULL,                                                        '{"maxLength": 40}',        NULL),
 ('17000000-0000-7000-8000-000000000011', '16000000-0000-7000-8000-000000000008', 'weight_kg',         'Weight (kg)',           'DECIMAL',       NULL,           false, 2, NULL,                                                        '{"min": 0, "max": 120}',   NULL),
 ('17000000-0000-7000-8000-000000000012', '16000000-0000-7000-8000-000000000008', 'vaccinations',      'Vaccinations up to date','LONG_TEXT',     NULL,           false, 3, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000013', '16000000-0000-7000-8000-000000000009', 'chief_complaint',   'Chief complaint',       'SHORT_TEXT',    NULL,           true,  1, NULL,                                                        '{"maxLength": 200}',       NULL),
 ('17000000-0000-7000-8000-000000000014', '16000000-0000-7000-8000-000000000009', 'history',           'History',               'LONG_TEXT',     NULL,           false, 2, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000015', '16000000-0000-7000-8000-00000000000a', 'diagnosis',         'Diagnosis',             'SHORT_TEXT',    NULL,           false, 1, NULL,                                                        '{"maxLength": 200}',       NULL),
 ('17000000-0000-7000-8000-000000000016', '16000000-0000-7000-8000-00000000000a', 'plan',              'Plan',                  'LONG_TEXT',     NULL,           false, 2, NULL,                                                        NULL,                       NULL),
 ('17000000-0000-7000-8000-000000000017', '16000000-0000-7000-8000-00000000000a', 'follow_up_days',    'Follow-up in (days)',   'INTEGER',       NULL,           false, 3, NULL,                                                        '{"min": 0, "max": 365}',   NULL);
...
INSERT INTO schedule_block (id, tenant_id, practitioner_id, starts_at, ends_at, reason) VALUES
 ('19000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', '0d000000-0000-7000-8000-000000000001', date_trunc('day', now()) + interval '1 day 12 hours', date_trunc('day', now()) + interval '1 day 13 hours', 'Lunch'),
 ('19000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', NULL,                                   date_trunc('day', now()) + interval '7 days',         date_trunc('day', now()) + interval '8 days',         'City holiday'),
 ('19000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000002', '0d000000-0000-7000-8000-000000000004', date_trunc('day', now()) + interval '12 hours',       date_trunc('day', now()) + interval '13 hours 30 minutes', 'Lunch');
...
INSERT INTO encounter (id, tenant_id, appointment_id, customer_id, dependent_id, practitioner_id, service_id, record_template_id, field_values, started_at, completed_at, status, signed_by) VALUES
 ('1a000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', '18000000-0000-7000-8000-000000000004', '10000000-0000-7000-8000-000000000003', NULL, '0d000000-0000-7000-8000-000000000001', '0f000000-0000-7000-8000-000000000001', '15000000-0000-7000-8000-000000000001', '{"pain_scale": 7, "region": "Lumbar", "body_map": [{"region": "lumbar", "mark": "pain", "note": "Moderate pain on palpation"}], "progress": "Patient reports improvement after the third session."}', date_trunc('day', now()) - interval '1 day' + interval '9 hours 5 minutes', date_trunc('day', now()) - interval '1 day' + interval '9 hours 55 minutes', 'COMPLETED', NULL),
 ('1a000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', NULL,                                   '10000000-0000-7000-8000-000000000002', NULL, '0d000000-0000-7000-8000-000000000002', '0f000000-0000-7000-8000-000000000002', '15000000-0000-7000-8000-000000000002', '{"weight_kg": 78.4, "height_cm": 175}',                                                                                                                        now() - interval '2 hours',                                                NULL,                                                                       'DRAFT',     NULL),
 ('1a000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', NULL,                                   '10000000-0000-7000-8000-000000000001', NULL, '0d000000-0000-7000-8000-000000000001', '0f000000-0000-7000-8000-000000000001', '15000000-0000-7000-8000-000000000001', '{"pain_scale": 5, "region": "Shoulder", "progress": "First session of the package."}',                                                                              now() - interval '1 month',                                                now() - interval '1 month' + interval '1 hour',                             'COMPLETED', NULL),
 ('1a000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000001', NULL,                                   '10000000-0000-7000-8000-000000000001', NULL, '0d000000-0000-7000-8000-000000000002', '0f000000-0000-7000-8000-000000000002', '15000000-0000-7000-8000-000000000002', '{"weight_kg": 62.0, "height_cm": 168, "goal": "Weight loss", "guidance": "1800 kcal plan, reassessment in 30 days."}',                              now() - interval '10 days',                                                now() - interval '10 days' + interval '45 minutes',                         'COMPLETED', NULL),
 ('1a000000-0000-7000-8000-000000000005', '0a000000-0000-7000-8000-000000000001', NULL,                                   '10000000-0000-7000-8000-000000000001', NULL, '0d000000-0000-7000-8000-000000000001', '0f000000-0000-7000-8000-000000000001', '15000000-0000-7000-8000-000000000001', '{"pain_scale": 8, "region": "Cervical", "progress": "Marked cervical tension, daily stretching advised."}',                                            now() - interval '20 days',                                                now() - interval '20 days' + interval '1 hour',                             'COMPLETED', NULL),
 ('1a000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000001', NULL,                                   '10000000-0000-7000-8000-000000000002', NULL, '0d000000-0000-7000-8000-000000000001', '0f000000-0000-7000-8000-000000000001', '15000000-0000-7000-8000-000000000001', '{"pain_scale": 4, "region": "Knee", "progress": "Post-surgical follow-up, good range of motion."}',                                                                  now() - interval '15 days',                                                now() - interval '15 days' + interval '1 hour',                             'COMPLETED', NULL),
 ('1a000000-0000-7000-8000-000000000007', '0a000000-0000-7000-8000-000000000002', '18000000-0000-7000-8000-000000000009', '10000000-0000-7000-8000-000000000006', NULL, '0d000000-0000-7000-8000-000000000004', '0f000000-0000-7000-8000-000000000006', '15000000-0000-7000-8000-000000000004', '{"odontogram": [{"region": "11", "mark": "healthy"}, {"region": "21", "parts": ["incisal"], "mark": "restored", "note": "Composite resin"}], "exam_notes": "Braces adjusted with no complications.", "procedure": "Braces adjustment"}',    date_trunc('day', now()) - interval '1 day' + interval '10 hours',          date_trunc('day', now()) - interval '1 day' + interval '10 hours 25 minutes', 'COMPLETED', NULL),
 ...
 ('1a000000-0000-7000-8000-000000000009', '0a000000-0000-7000-8000-000000000003', NULL,                                   '10000000-0000-7000-8000-000000000007', NULL, '0d000000-0000-7000-8000-000000000005', '0f000000-0000-7000-8000-000000000007', '15000000-0000-7000-8000-000000000005', '{"species": "Dog", "weight_kg": 32.5}',                                                                                                                        now() - interval '3 hours',                                                NULL,                                                                       'DRAFT',     NULL);
...
INSERT INTO invoice (id, tenant_id, encounter_id, customer_id, insurance_plan_id, gross_amount, discount, net_amount, due_date, status, discount_reason, coverage, created_at) VALUES
 ...
 ('1b000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', '1a000000-0000-7000-8000-000000000004', '10000000-0000-7000-8000-000000000001', NULL, 150.00, 105.00,  45.00, CURRENT_DATE - 3,   'PARTIAL', 'Unimed Curitiba covers 70% of the amount',     'INSURANCE',       now() - interval '10 days'),
 ...
 ('1b000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000002', '1a000000-0000-7000-8000-000000000007', '10000000-0000-7000-8000-000000000006', NULL,  90.00,  10.00,  80.00, CURRENT_DATE + 6,   'OPEN',    'Loyalty discount',                 'DIRECT',          now() - interval '1 day');

INSERT INTO invoice_item (id, invoice_id, service_id, description, quantity, unit_price) VALUES
 ('1c000000-0000-7000-8000-000000000001', '1b000000-0000-7000-8000-000000000001', '0f000000-0000-7000-8000-000000000001', 'Physiotherapy Session', 1, 180.00),
 ('1c000000-0000-7000-8000-000000000002', '1b000000-0000-7000-8000-000000000002', '0f000000-0000-7000-8000-000000000001', 'Physiotherapy Session', 1, 180.00),
 ('1c000000-0000-7000-8000-000000000003', '1b000000-0000-7000-8000-000000000003', '0f000000-0000-7000-8000-000000000002', 'Nutrition Consultation', 1, 150.00),
 ('1c000000-0000-7000-8000-000000000004', '1b000000-0000-7000-8000-000000000004', '0f000000-0000-7000-8000-000000000001', 'Physiotherapy Session', 1, 180.00),
 ('1c000000-0000-7000-8000-000000000005', '1b000000-0000-7000-8000-000000000005', '0f000000-0000-7000-8000-000000000001', 'Physiotherapy Session', 1, 180.00),
 ('1c000000-0000-7000-8000-000000000006', '1b000000-0000-7000-8000-000000000006', '0f000000-0000-7000-8000-000000000006', 'Braces Adjustment',      1,  90.00);
...
INSERT INTO payment (id, tenant_id, invoice_id, amount, method, paid_at, recorded_by, refunded_at, refund_reason) VALUES
 ...
 ('1d000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', '1b000000-0000-7000-8000-000000000004', 180.00, 'CASH',   now() - interval '20 days', '0b000000-0000-7000-8000-000000000003', now() - interval '18 days', 'Encounter rescheduled at the customer request');
...
-- ---------------------------------------------------------------------------
-- Inventory and batches (Vida Clinic)
-- ---------------------------------------------------------------------------

INSERT INTO product (id, tenant_id, name, unit, min_stock, batch_controlled, status, on_hand) VALUES
 ('20000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', 'Examination Glove',    'BOX',  5.00, false, 'ACTIVE',   12.00),
 ('20000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', 'Conductive Gel',       'UN', 10.00, true,  'ACTIVE',    8.00),
 ('20000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', 'Alcohol 70%',          'L',   3.00, true,  'ACTIVE',    6.00),
 ('20000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000001', 'Disposable Needle',    'UN', 20.00, false, 'INACTIVE',  0.00);
...
INSERT INTO stock_movement (id, tenant_id, product_id, batch_id, encounter_id, movement_type, quantity, reason, recorded_by, recorded_at) VALUES
 ('22000000-0000-7000-8000-000000000001', '0a000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000001', NULL,                                   NULL,                                   'INBOUND',  20.00, 'Initial purchase',    '0b000000-0000-7000-8000-000000000002', now() - interval '30 days'),
 ...
 ('22000000-0000-7000-8000-000000000003', '0a000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000002', '21000000-0000-7000-8000-000000000001', NULL,                                   'INBOUND',   5.00, 'Monthly restock',     '0b000000-0000-7000-8000-000000000002', now() - interval '25 days'),
 ('22000000-0000-7000-8000-000000000004', '0a000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000002', '21000000-0000-7000-8000-000000000002', NULL,                                   'INBOUND',   3.00, 'Monthly restock',     '0b000000-0000-7000-8000-000000000002', now() - interval '90 days'),
 ('22000000-0000-7000-8000-000000000005', '0a000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000003', '21000000-0000-7000-8000-000000000003', NULL,                                   'INBOUND',   6.00, 'Monthly restock',     '0b000000-0000-7000-8000-000000000002', now() - interval '20 days'),
 ('22000000-0000-7000-8000-000000000006', '0a000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000003', '21000000-0000-7000-8000-000000000004', NULL,                                   'INBOUND',   4.00, 'Monthly restock',     '0b000000-0000-7000-8000-000000000002', now() - interval '120 days'),
 ('22000000-0000-7000-8000-000000000007', '0a000000-0000-7000-8000-000000000001', '20000000-0000-7000-8000-000000000003', '21000000-0000-7000-8000-000000000004', NULL,                                   'DISCARD',   4.00, 'Expired batch',       '0b000000-0000-7000-8000-000000000002', now() - interval '5 days');

-- ---------------------------------------------------------------------------
-- Session packages (Vida Clinic)
-- ---------------------------------------------------------------------------
...
INSERT INTO notification (id, tenant_id, appointment_id, channel, recipient, sent_at, status, reply, replied_at) VALUES
 ...
 ('25000000-0000-7000-8000-000000000002', '0a000000-0000-7000-8000-000000000001', '18000000-0000-7000-8000-000000000001', 'EMAIL',    'ana.prado@mail.com', now() - interval '1 day',   'REPLIED', 'CONFIRM', now() - interval '20 hours'),
